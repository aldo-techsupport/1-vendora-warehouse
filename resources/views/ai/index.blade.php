                    ...
                    <div class="chat-messages" id="chatMessages">
                        ...
                        <div class="chat-bubble chat-bubble-assistant">
                            <div class="font-weight-bold text-purple mb-1" style="font-size: 12px;">
                                <i class="fas fa-robot mr-1"></i> Vendora AI Advisor
                            </div>
                            <div>
                                Halo <strong>{{ auth()->user()->name }}</strong>! Saya adalah asisten pintar toko Vendora Warehouse. Anda bisa menanyakan apa saja mengenai:
                            ...
                            @elseif($msg->role === 'assistant')
                                <div class="chat-bubble chat-bubble-assistant">
                                    <div class="font-weight-bold text-purple mb-1" style="font-size: 11px;">
                                        <i class="fas fa-robot mr-1"></i> Asisten Penjualan Vendora
                                    </div>
