...
@section('page_actions')
    <span class="badge badge-success px-2.5 py-1.5 mr-2 font-weight-normal shadow-xs" style="font-size: 11px;">
        <i class="fas fa-hdd mr-1"></i> Penyimpanan: Komputer Lokal (storage/app/public/packing_videos)
    </span>
