...
<head>
    ...
    <title>@yield('title', 'Dashboard') - {{ $currentAppName ?? 'Vendora Shopee Management' }}</title>
    ...
    <style>
        :root {
            ...
            --vendora-primary: #1e3a8a;
            --vendora-accent: #0284c7;
        }
        * {
...
<div class="wrapper">
    ...
    <footer class="main-footer text-sm d-none d-md-block">
        <div class="float-right d-none d-sm-inline">
            <strong>Vendora Warehouse</strong> v1.0.0
        </div>
        <span>&copy; {{ date('Y') }} Vendora Warehouse & Shopee Open API Sync. All rights reserved.</span>
    </footer>
</div>
<!-- ./wrapper -->
