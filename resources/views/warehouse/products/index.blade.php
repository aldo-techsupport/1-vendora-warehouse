            ...
            <form action="{{ route('warehouse.products.store') }}" method="POST">
                ...
                <div class="modal-body p-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control form-control-sm" placeholder="Contoh: Gamis Vendora Silk Premium" required>
                    </div>

                    <div class="form-row">
                        <div class="form-group col-6">
                            <label class="font-weight-semibold text-sm">SKU <span class="text-danger">*</span></label>
                            <input type="text" name="sku" class="form-control form-control-sm" placeholder="VND-GMS-001" required>
                        </div>
                        <div class="form-group col-6">
